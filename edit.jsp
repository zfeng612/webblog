...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Zhan's Blog - Edit: session.setAttribute(), session.getAttribute(), response.redirect()</title>
    ...
    <body>
        ...
        <h1>Edit</h1>
        <h2>Security Sample Project - EDIT Page</h2>
        ...
        <%
            ...
            if (user_Name == null) {
                redirectMsg = "Sorry you cannot access the EDIT page because you are not logged in.";
            } else if (!user_Role.equalsIgnoreCase("user")
                    && !user_Role.equalsIgnoreCase("admin")) {
                redirectMsg = "Sorry you are not authorized to access the EDIT page.";
            }
        ...
        <br/>
        <br/>
        <h3>You are allowed to access this EDIT page.</h3>        <%@ include file= "post-content.html" %> 
    </body>
</html>
